    ...
    <Layout>
      <section className="flex flex-col lg:flex-row items-center lg:space-x-4 lg:p-8">
          ...
          <div>
            ...
            <p className="m-2">
              I'm also the author of <Link isExternal={true} href="https://www.apress.com/us/book/9781484262962">Using Gatsby and Netlify CMS</Link> and {' '}
              <Link isExternal={true} href="https://www.apress.com/us/book/9781484262931">Modern CSS</Link>.
            </p>
            <p className="m-2">
              Currently, I'm a <strong>Staff Software Engineer</strong> at <Link isExternal={true} href="https://synopsys.com">Synopsys</Link>. In the past, I have
